...
export const ResumeSection: React.FC<ResumeSectionProps> = ({ onOpenModal, onToast }) => {
  ...
  return (
    <section id="resume" className="py-24 relative select-none">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="relative rounded-3xl overflow-hidden bg-[#12131a] border border-white/10 p-6 sm:p-10 lg:p-12">
          ...
          <div className="relative z-10 pb-8 mb-8 border-b border-white/10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-red-500/10 text-xs font-mono text-red-400 border border-red-500/20 mb-2.5">
                <Sparkles className="w-3 h-3 text-red-400" /> Available for AI/ML Internships
              </div>
              <h3 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-white uppercase">
                {personalInfo.name}
              </h3>
              <p className="text-xs sm:text-sm font-semibold text-zinc-300 uppercase tracking-wider mt-1 font-mono">
                {personalInfo.title}
              </p>
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 pt-3 text-xs font-mono text-zinc-400">
                <span className="flex items-center gap-1.5">
                  <MapPin className="w-3.5 h-3.5 text-red-400" /> Vijayawada, India
                </span>
                <span>•</span>
                <a href={`mailto:${personalInfo.socials.email}`} className="flex items-center gap-1.5 hover:text-white transition-colors">
                  <Mail className="w-3.5 h-3.5 text-red-400" /> {personalInfo.socials.email}
                </a>
                <span>•</span>
                <a href="tel:+918121467245" className="flex items-center gap-1.5 hover:text-white transition-colors">
                  <Phone className="w-3.5 h-3.5 text-red-400" /> +91-8121467245
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 shrink-0">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-red-600 hover:bg-red-500 text-white font-bold text-xs uppercase tracking-wider shadow-lg shadow-red-950/50 hover:scale-105 transition-all duration-200"
              >
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-full text-xs font-semibold tracking-wide transition-all whitespace-nowrap ${
                    isActive
                      ? 'bg-red-600 text-white shadow-lg shadow-red-950/60'
                      : 'bg-[#0c0d12] text-zinc-400 border border-white/10 hover:border-red-500/40 hover:text-white'
                  }`}
                >
          ...
          <div className="min-h-[280px]">
              ...
              <div className="space-y-6 animate-fadeIn">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0c0d12] hover:bg-white/10 text-zinc-300 text-xs font-mono transition-colors border border-white/10"
                  >
                ...
                <div className="p-6 sm:p-7 rounded-2xl bg-[#0c0d12] border border-white/10">
            ...
            {activeTab === 'experience' && (
              <div className="space-y-6 animate-fadeIn">
                {experienceData.map((item) => (
                  <div key={item.id} className="p-6 rounded-2xl bg-[#0c0d12] border border-white/10 space-y-4">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2">
                      ...
                      <span className="inline-block px-3 py-1 rounded-full text-[11px] font-mono bg-red-500/10 text-red-400 border border-red-500/20 w-fit">
                        {item.duration}
                      </span>
                    </div>
            ...
            {activeTab === 'education' && (
              <div className="space-y-4 animate-fadeIn">
                ...
                {/* College */}
                <div className="p-6 rounded-2xl bg-[#0c0d12] border border-white/10">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-xs font-mono text-red-400">{educationInfo.year}</span>
                  </div>
            ...
            {activeTab === 'skills' && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-fadeIn">
                ...
                <div className="p-5 rounded-2xl bg-[#0c0d12] border border-white/10">
                  <h4 className="text-sm font-bold text-white mb-2 flex items-center gap-2">
                    <Code2 className="w-4 h-4 text-red-400" /> Languages &amp; Core
                  </h4>
                ...
                <div className="p-5 rounded-2xl bg-[#0c0d12] border border-white/10">
                  <h4 className="text-sm font-bold text-white mb-2 flex items-center gap-2">
                    <BrainCircuit className="w-4 h-4 text-red-400" /> AI &amp; Analytics
                  </h4>
                  <ul className="space-y-1.5 text-xs text-zinc-300 font-mono">
                ...
                <div className="p-5 rounded-2xl bg-[#0c0d12] border border-white/10">
                  <h4 className="text-sm font-bold text-white mb-2 flex items-center gap-2">
                    <Sparkles className="w-4 h-4 text-red-400" /> Professional Skills
                  </h4>
                  <ul className="space-y-1.5 text-xs text-zinc-300 font-mono">
          ...
          {/* Bottom Card Footer */}
          <div className="pt-8 mt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-zinc-400">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <LinkedinIcon className="w-3.5 h-3.5 text-red-400" /> LinkedIn
              </a>
              <a
                ...
                className="hover:text-white flex items-center gap-1 transition-colors"
              >
                <GithubIcon className="w-3.5 h-3.5 text-red-400" /> GitHub
              </a>
            </div>
          </div>
